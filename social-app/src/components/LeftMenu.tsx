...
const LeftMenu = ({ type }: { type: "home" | "profile" }) => {
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="p-4 bg-white rounded-lg shadow-md text-sm text-gray-500 flex flex-col mt-8 gap-2">
        <Link
          href="/"
        ...
        <Link
          href="/"
          className="flex items-center gap-4 py-2  rounded-lg hover:bg-slate-100"
        >
          <Image src="/activity.png" alt="" width={28} height={28} />
          <span>Activity</span>
        </Link>
        <hr className="border-t-1 border-gray-50 w-36 self-center" />
        <Link
        ...
        <Link
          ...
          className="flex items-center gap-4 py-2 rounded-lg hover:bg-slate-100"
        >
          <Image src="/settings.png" alt="" width={28} height={28} />
          <span>Settings</span>
        </Link>
      </div>
      <Ad size="sm"/>
